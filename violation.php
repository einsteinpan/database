...
<div class="card-body">
	...
	<table align = center cellpadding='5' border='1'>
		<div class="container">
					...
					$sql ="select * from student where ID='$account';"; //SQL語句
					$result = mysqli_query($link,$sql); //查詢
						while($row = mysqli_fetch_array($result))
		                {
							...
							echo'<td><font size ="4" face"標楷體"color = white>查看違規紀錄</td>';
							echo'</tr>';
							$id=$row['ID'];
							echo'<tr>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['ID'].'</td>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['SName'].'</td>';
							echo "<td><a href=violationrecord.php?account=$account><input type = button value = 查看></a></td>";
							echo'</tr>';
				        }
		            ?>
		</table>
