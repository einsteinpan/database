...
//    mysqli_free_result($result);
  ...
  $iden = "select identity from account inner join identity on identity.Idnumber=account.Idnum where `account`='$account';";
$result1 = mysqli_query($conn, $iden);
                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $identity; ?></span>
                        </a>
