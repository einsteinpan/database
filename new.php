...
<?php
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
				...
				<li class="nav-item">
                    <a class="nav-link collapsed" href="violation.php">
                        <i class="bi bi-envelope"></i>
                        <span>違規查詢</span>
                    </a>
                </li>
...
<div class="card-body">
    ...
    <div class="pt-4 pb-2">
        <h5 class="card-title text-center pb-0 fs-4">學生列表</h5>
    </div>
	...
	<table align = center cellpadding='5' border='1'>
		<div class="container">
					...
					$sql ="select * from `appinformation`;"; //SQL語句
					$result = mysqli_query($link,$sql); //查詢
					echo'<tr>';
					echo'<td><font size ="4" face"標楷體"color = white>學號</td>';
					echo'<td><font size ="4" face"標楷體"color = white>年度</td>';
                    echo'<td><font size ="4" face"標楷體"color = white>日期</td>';
					echo'<td><font size ="4" face"標楷體"color = white>繳費</td>';
                    echo'<td><font size ="4" face"標楷體"color = white>bname</td>';
					echo'</tr>';
						while($row = mysqli_fetch_array($result))
		                {
							$id=$row['SID'];
							echo'<tr>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['SID'].'</td>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['schoolyear'].'</td>';
                            echo'<td><font size ="4" face"標楷體"color = white>'.$row['ADate'].'</td>';
                            echo'<td><font size ="4" face"標楷體"color = white>'.$row['Paymentstatus'].'</td>';
                            echo'<td><font size ="4" face"標楷體"color = white>'.$row['bname'].'</td>';
