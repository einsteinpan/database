            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">違規公告</li>
                    </ol>
                </nav>
            </div>
            <!-- End Page Title -->
...
<div class="card-body">
	...
	<table align = center cellpadding='5' border='1'>
		<div class="container">
					...
					$sql ="select * from `student` INNER JOIN `account` ON `student`.`ID` = `account`.`SID` ;"; //SQL語句
					...
					echo'<td><font size ="4" face"標楷體"color = white>操作</td>';
					echo'</tr>';
						while($row = mysqli_fetch_array($result))
		                {
							$id=$row['ID'];
							...
							echo "<td><a href=violationrenew.php?account=$account&&id=$id><input type = button value = 修改></a></td>";
							echo'</tr>';
				        }
		            ?>
		</table>
