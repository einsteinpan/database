...
<div class="card-body">
    ...
    <div class="pt-4 pb-2">
        <h5 class="card-title text-center pb-0 fs-4">列表</h5>
    </div>
	...
	<table align = center cellpadding='5' border='1'>
		<div class="container">
					...
					$sql ="select * from violationrecord where SID='$account';"; //SQL語句
					...
					echo'<tr>';
							...
							echo'<td><font size ="4" face"標楷體"color = white>查看違規</td>';
							echo'</tr>';
						while($row = mysqli_fetch_array($result))
		                {
							...
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['VDate'].'</td>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['content'].'</td>';
							echo'</tr>';
				        }
		            ?>
		</table>
