...
<?php
  ...
  $sql = "SELECT select identity from account inner join identity on identity.Idnumber=account.Idnum where `account`='$account';";
                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $result1 ?></span>
                        </a>
                        <!-- End Profile Iamge Icon -->

                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            <li class="dropdown-header">
                                <h6><?php echo $result1 ?></h6>
                                <span>學生</span>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
