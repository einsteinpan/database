...
<div class="card-body">
	...
	<table align = center cellpadding='5' border='1'>
		<div class="container">
					...
					echo'<td><font size ="4" face"標楷體"color = white>房間</td>';
                    echo'<td><font size ="4" face"標楷體"color = white>宿舍</td>';
					echo'</tr>';
						while($row = mysqli_fetch_array($result))
		                {
							$id=$row['ID'];
							echo'<tr>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['ID'].'</td>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['SName'].'</td>';
                            echo'<td><font size ="4" face"標楷體"color = white>'.$row['roomnum'].'</td>';
							echo'<td><font size ="4" face"標楷體"color = white>'.$row['bname'].'</td>';
							echo "<td><a href=seerenew.php?account=$account&&id=$id><input type = button value = 修改></a></td>";
							echo'</tr>';
				        }
		            ?>
		</table>
