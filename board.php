...
<li class="nav-item">
	<a class="nav-link collapsed" href="board.php">
		<i class="bi bi-box-arrow-in-right"></i>
		<span>留言板</span>
	</a>
</li>
...
<div class="card-body">
    ...
    <div class="pt-4 pb-2">
        <h5 class="card-title text-center pb-0 fs-4">留言板</h5>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
			...
			<tr>
			<td>留言日期:</td><td><input type="date" name='Date' value=""><br/></td>
			</tr>
			<tr>
			<td>留言內容:</td><td><input type="text" name='boardvalue' value=""><br/></td>
			</tr>
			<tr>
			<td><input type="submit" value= "送出" onClick="return showmessage()"></td>
			</tr>
			</form>
			<?php
			...
			$sql ="select `Date`,`boardvalue` from board where SID='$id' ;"; //SQL語句
			...
			if(isset($_POST['boardvalue'])) {
				echo "content: ".htmlspecialchars($_POST['boardvalue']);
				$boardvalue = $_POST['boardvalue'];
				$date = $_POST['Date'];
				$sql="INSERT INTO board(`SID`,`Date`,`boardvalue`) VALUES ('$id','$date','$boardvalue')";
				$result = mysqli_query($conn,$sql); //查詢
				header("location:mainface.php?account=$account");
			}
